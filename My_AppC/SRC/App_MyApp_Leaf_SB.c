...
static const uint32_t timerPeriod = 3000;
...
static void sendCoAP2()
{
    ...
    // Send temperature and humidity to root node. The URI is "coap://[root-node-ip]/data"
...
RIIM_SETUP()
{
   ...
   GPIO.setValue(GPIO_4, LOW);
	...
	startupTimerHandler = Timer.create(PERIODIC, 3000, startup);
